class LookupCountry < ActiveRecord::Base
  attr_accessible :country_name, :fips104, :iso2, :iso3, :ison, :internet, :capital, :map_reference, :nationality, :currency, :currency_code, :population, :description, :english_speakers_percentage, :last_call_time
